...
public class LoginPage 
{
	...
	public void click_rememberme_checkbox() throws Exception
	{
		
		driver.findElement(By.cssSelector(ReadPropFile.read_element_data("llogin_rememberme_css"))).click();
	...
	public void click_loginbttn() throws Exception
	{
		...
		driver.findElement(By.className(ReadPropFile.read_element_data("login_loginbutton_class"))).click();
